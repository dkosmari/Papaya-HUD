...
docker run $ARGS sh -c "./bootstrap && ./configure --host=powerpc-eabi CXXFLAGS='-Ofast -ffunction-sections -fipa-pta' LDFLAGS='-flto=auto -fdevirtualize-at-ltrans' && make" || cleanup 2
