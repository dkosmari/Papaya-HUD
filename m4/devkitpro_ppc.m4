...
#   - `DEVKITPRO_HOST': set to `powerpc-eabi-'
#   - `DEVKITPRO_PATH': appends `:$DEVKITPPC/bin' if necessary.
...
AC_DEFUN([DEVKITPRO_PPC_INIT],[
    ...
    AS_VAR_SET_IF([DEVKITPRO_HOST],
                  [],
                  [AS_VAR_SET([DEVKITPRO_HOST], [powerpc-eabi-])])
    ...
    # DEVKITPRO_PATH
    DEVKITPRO_APPEND_TOOL_PATH([${DEVKITPRO_HOST}nm], [${DEVKITPPC}/bin])
